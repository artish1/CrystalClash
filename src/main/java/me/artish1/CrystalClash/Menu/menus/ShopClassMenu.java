...
public class ShopClassMenu implements Menu, Listener{
	private String name;
	private Menu parent;
	private int size;
	...
	public ShopClassMenu(String name,int size, JavaPlugin plugin, Menu parent) {
		this.name = name;
		this.size = size;
		this.parent = parent;
	    ...
	    addItem(0, new GuardianItem(this));
	    
	    addItem(1, new NecromancerItem(this));
	...
	public ShopClassMenu addItem(int index, MenuItem item){
		items[index] = item;
		items1.add(item);
