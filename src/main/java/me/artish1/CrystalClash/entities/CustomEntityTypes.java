...
public class CustomEntityTypes<T extends EntityLiving> {
    ...
    public CustomEntityTypes(String name, Class<T> customEntityClass, EntityTypes<? super T> parentType,
    ...
    public void register() throws IllegalStateException {
        ...
        if(key == null) {
            ...
            if(parentType == null) {
                System.out.println("---------------------PArentType is NUll------------------");
            } else {
                if (parentType.h() == null) {
                    System.out.println("-------------Parent type DOT H is null -------------");
                }
            }
        }

        if (dataTypes == null) {
            System.out.println("----------------------DATA TYPES IS NULL ------------------");
        }
    ...
    public void unregister() throws IllegalStateException {
        ...
        try {
            ...
            if (REGISTRY_MAT_MAP == null) {
                throw new Exception("Field not initially found");
            }
